...
from RL.DQN_Pong.utils.general import get_logger, Progbar, export_plot
from RL.DQN_Pong.utils.replay_buffer import ReplayBuffer
from RL.DQN_Pong.utils.preprocess import greyscale
from RL.DQN_Pong.utils.wrappers import PreproWrapper, MaxAndSkipEnv
...
class QN(object):
    ...
    def record(self):
        ...
        # env = gym.wrappers.Monitor(env, self.config.record_path, video_callable = False, force = True, resume=True)
